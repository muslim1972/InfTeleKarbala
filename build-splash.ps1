"$b64 = [Convert]::ToBase64String([IO.File]::ReadAllBytes('public\\logo-new.png'))
...
<div class=ct>
<div class=lc id=lc><img class=li alt=Logo src=\"data:image/png;base64,PLACEHOLDER\"></div>
...
[System.IO.File]::WriteAllText('splash_standalone.html', $html, [System.Text.UTF8Encoding]::new($false))

Write-Host \"✅ تم إنشاء الملف: splash_standalone.html\"
Write-Host \"📏 الحجم: $((Get-Item 'splash_standalone.html').Length / 1KB) KB\""