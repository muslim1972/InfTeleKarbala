...
const base64Image = fs.readFileSync(path.join(__dirname, 'public', 'logo-new.png')).toString('base64');
...
console.log('✅ تم إنشاء الملف: splash_standalone.html');
console.log('📏 الحجم: ' + (fs.statSync(outputPath).size / 1024).toFixed(0) + ' KB');
console.log('');
console.log('📱 أرسل splash_standalone.html عبر واتساب.');
console.log('   عند فتحه سيعمل لمدة 20 ثانية مع الصوت والمؤثرات.');
"