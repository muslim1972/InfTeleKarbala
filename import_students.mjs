...
// نستخدم مفتاح Service Role لأنه يمتلك صلاحيات كاملة، وإذا لم يتوفر نستخدم Anon Key
...
async function importData() {
    ...
    for (const row of data) {
        ...
        const { error } = await supabase.rpc('create_training_student', {
            ...
            p_username: fullName.trim(), // الاسم الثلاثي هو اسم المستخدم
            p_password: password.trim(), // الرمز هو كلمة المرور
            ...
            p_supervisor_id: null // لم يتم تحديد مشرف محدد برمجياً عند الاستيراد
        });
