  ...
  const finalize = async (): Promise<void> => {
    ...
    if (user) {
      ...
      try {
        ...
        /* حفظ المشروع يبقى بيد المستخدم من زر «حفظ المشروع» (بنفس
           الاسم تحديث / باسم معدل نسخة جديدة) — يمنع تضارب الأسماء */
        setSavedMsg('حُفظت النتيجة في قاعدة البيانات — لحفظ التصميم استخدم زر «حفظ المشروع» في الرأس');
      } catch (e) {
