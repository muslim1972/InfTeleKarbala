/**
 * ============================================================
 * بوابة الميزة — فحوص الحساب والشاشة
 * ============================================================
 * 1) بوابة الحساب: isDeveloperAccount تُستخدم الآن كتجاوز دائم
 *    لحساب المطور داخل نظام المنح عبر «صلاحيات الحقول»
 *    (انظر ftthAccess.ts) — بقية الحسابات تُحكم بصلاحية
 *    ftth_simulator من جدول field_permissions.
