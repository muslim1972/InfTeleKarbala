...
import { BookOpen, FileSpreadsheet, Upload, Save, X, Loader2, ToggleLeft, ToggleRight, Clock, Trophy, Trash2, ChevronDown } from 'lucide-react';
...
export const AdminPromotionTab = () => {
    ...
    const { user } = useAuth();
    const { settings, settingsLoading, updateSettings, uploadFile, fetchResults } = usePromotionData();
            ...
            {openSection === 'curricula' && (
                <div className={cn(
                    ...
                    <DropdownField
                        ...
                        onChange={val => { setCurrCourseType(val as CourseType); setCurrSubject(null); }}
                    />
                    {currCourseType && (
                        <DropdownField
                            label="اسم المادة"
                    ...
                    <div className="flex gap-2 pt-2">
                        <button
                            ...
                            disabled={currUploading || !currCourseType || !currSubject || !currFile}
            ...
            {openSection === 'exams' && (
                <div className={cn(
                    ...
                    <DropdownField
                        ...
                        onChange={val => { setExamCourseType(val as CourseType); setExamSubject(null); }}
                    />
                    {examCourseType && (
                        <DropdownField
                            label="اسم المادة"
                    ...
                    <div className="flex gap-2 pt-2">
                        <button
                            ...
                            disabled={examUploading || !examCourseType || !examSubject || !examFile}
                            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm transition-all disabled:opacity-50 active:scale-95"
                        >
