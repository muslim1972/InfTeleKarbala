...
export function HRDocumentProcessingPanel({ record, onClose, onSuccess, currentUser }: HRDocumentProcessingPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 pb-28 md:pb-32 pt-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white dark:bg-slate-800 w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300 flex flex-col max-h-[calc(100vh-9rem)]">
        {/* Header */}
