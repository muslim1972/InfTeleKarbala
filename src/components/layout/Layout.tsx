        ...
        <div className="absolute inset-0 overflow-y-auto overflow-x-hidden bg-background text-foreground font-tajawal transition-colors duration-300">
            ...
            <div className="relative z-10 flex flex-col h-full min-h-screen">
                ...
                <button
                    ...
                    className="fixed bottom-[calc(7.5rem+env(safe-area-inset-bottom))] left-6 z-50 w-20 h-20 rounded-full transition-all duration-300 transform hover:scale-110 active:scale-95 group p-0 flex items-center justify-center focus:outline-none"
                >
